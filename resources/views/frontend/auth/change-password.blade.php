		...
		<div class="col-md-10 col-md-offset-1">
                       ...
                       {!! Form::open(['route' => ['password.change'], 'class' => 'form-horizontal']) !!}
                              ...
                              <div class="form-group">
                                  <div class="col-md-6 col-md-offset-4">
                                      {!! Form::submit(trans('labels.change_password_button'), ['class' => 'btn btn-info']) !!}
                                  </div>
                              </div>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
				    ...
				    {!! Form::open(['route' => ['profile.change'], 'id' => 'info-form', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal']) !!}
                        <!--<form action="http://savycon.com/auth/password/changeauth/pass/prof" id="info-form" method="POST" class="form-horizontal" enctype="multipart/form-data">-->
                            {{ csrf_field() }}
                            <input type="hidden" value="{{ $id }}" name="id">
                        
                                <br><br>
                              <div class="form-group" style="display: block;">
                                  <label class="col-md-4 control-label" for="old_name"
                                  +6>Name </label>
                                 
                                  <div class="col-md-6">
                                      <input type="text" name="old_name" value="{{ $name }}" class="form-control">
                                  </div>
                              </div>
                                
                              <div class="form-group">
                                  <label for="old_email" class="col-md-4 control-label">Email </label>
                                
                                  <div class="col-md-6">
                                      <input type="text" name="old_email" value="{{ $email }}" class="form-control">
                              ...
                              <!--<div class="form-group">-->
                              <!--    <label class="col-md-4 control-label" for="old_image">Change Image </label>-->
                                 
                              <!--    <div class="col-md-6">-->
                              <!--        <input type="file" name="old_imaage" class="form-control">-->
                              <!--    </div>-->
                              <!--</div>-->
